L.Control.Measure = L.Control.extend({
  ...
  _updateTooltipDistance: function (total, difference) {
    ...
    var text = '<div class="leaflet-measure-tooltip-total" style="font-size:15px;  color:'+ this.options.textColor +'">' + totalRound + '</div>'
    if (differenceRound > 0 && totalRound !== differenceRound) {
      text += '<div class="leaflet-measure-tooltip-difference" style="font-size:15px;  color:'+ this.options.textColor +'">(+' + differenceRound + ')</div>'
    }
